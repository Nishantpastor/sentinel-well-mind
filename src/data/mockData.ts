...
function factors(values: number[]): RiskFactor[] {
  const labels = [
    "Duty Hours",
    "Night Shifts",
    "Sleep Quality",
...
/** Correlated synthetic profiles — deliberately not random. */
const RAW: Array<{
  id: string;
  unit: string;
  role: string;
...
export const PERSONNEL: Personnel[] = RAW.map((p) => {
...
export const UNITS: Unit[] = [
  { id: "unit-a", name: "Unit A", personnel: 320, band: "LOW", trend: "Stable", averageRisk: 31 },
  {
    id: "unit-b",
    name: "Unit B",
    personnel: 340,
  ...
  { id: "unit-c", name: "Unit C", personnel: 295, band: "HIGH", trend: "Increasing", averageRisk: 71 },
  { id: "unit-d", name: "Unit D", personnel: 295, band: "LOW", trend: "Stable", averageRisk: 27 },
];
...
export const ALERTS: WelfareAlert[] = [
  {
    id: "AL-4401",
    personnelId: "P-1024",
    unit: "Unit A",
  ...
  },
  {
    ...
    previousScore: 70,
    detectedChanges: [
      "Three consecutive assessments reporting mental exhaustion",
      "Self-reported stress rose from 5 to 7",
    ],
...
export const NOTIFICATIONS = [
  { id: "N1", title: "New high-risk welfare alert", detail: "P-1024 · Unit A", time: "10:42 AM" },
  { id: "N2", title: "Intervention recorded", detail: "IN-201 · In Progress", time: "09:31 AM" },
  {
    id: "N3",
  ...
  { id: "N4", title: "Weekly wellness report available", detail: "Week 25 summary", time: "Monday" },
];

export const COMMANDER_SUMMARY = {
  total: 350,
  low: 250,
  moderate: 72,
  high: 22,
...
export const UNIT_TREND = [
  { month: "Jan", unitA: 30, unitB: 38, unitC: 48, unitD: 26 },
  { month: "Feb", unitA: 30, unitB: 42, unitC: 54, unitD: 26 },
  { month: "Mar", unitA: 31, unitB: 45, unitC: 60, unitD: 27 },
  { month: "Apr", unitA: 31, unitB: 48, unitC: 64, unitD: 27 },
  { month: "May", unitA: 32, unitB: 51, unitC: 68, unitD: 28 },
  { month: "Jun", unitA: 31, unitB: 54, unitC: 71, unitD: 27 },
];

export const WORKLOAD_TREND = [
  { month: "Jan", hours: 168, target: 180 },
  { month: "Feb", hours: 174, target: 180 },
  { month: "Mar", hours: 182, target: 180 },
  { month: "Apr", hours: 190, target: 180 },
  { month: "May", hours: 196, target: 180 },
  { month: "Jun", hours: 204, target: 180 },
];

export const DEPLOYMENT_DISTRIBUTION = [
  { band: "0-30 days", personnel: 96 },
  { band: "31-90 days", personnel: 118 },
  { band: "91-150 days", personnel: 84 },
  { band: "151+ days", personnel: 52 },
];

export const LEAVE_UTILISATION = [
  { unit: "Unit A", utilised: 74 },
  { unit: "Unit B", utilised: 58 },
  { unit: "Unit C", utilised: 41 },
  { unit: "Unit D", utilised: 78 },
];

export const FATIGUE_INDICATORS = [
  { month: "Jan", nightShifts: 8, sleepDeficit: 12 },
  { month: "Feb", nightShifts: 10, sleepDeficit: 15 },
  { month: "Mar", nightShifts: 12, sleepDeficit: 19 },
  { month: "Apr", nightShifts: 14, sleepDeficit: 24 },
  { month: "May", nightShifts: 17, sleepDeficit: 28 },
  { month: "Jun", nightShifts: 19, sleepDeficit: 33 },
];

/** Personnel-facing self series for the demo personnel account (P-1024). */
export const MY_PROFILE = PERSONNEL[0]!;
export const MY_SERIES = MY_PROFILE.series;
